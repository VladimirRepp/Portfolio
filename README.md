...
**Full-Stack разработчик, работаю с 2017 года** <br/>
Создаю комплексные решения полного цикла — от **игровых прототипов** и **мобильных приложений** до **enterprise-систем** и **веб-платформ**. <br/>
...
* [Create Process (.Net)](https://github.com/VladimirRepp/CS---CreateProcess)
* [Child Processes (.Net)](https://github.com/VladimirRepp/CS---ChildeProcesses)
* [Assembly & Module (.Net)](https://github.com/VladimirRepp/CS---AssemblyAndModule)
* [Run Two Apps Using AppDomain (.Net)](https://github.com/VladimirRepp/CS---RunTwoAppUsingAppDoman)
* [AppDomain (.Net)](https://github.com/VladimirRepp/CS---AppDomain)
* [Thread Pool Examples (.Net)](https://github.com/VladimirRepp/CS---PoolThreads)
* [Synchronization Methods (Thread) (.Net)](https://github.com/VladimirRepp/CS---SynchronizationMethodsUsingThread)
* [UDP Chat (.Net)](https://github.com/VladimirRepp/CS---UpdChat)
* [TCP Chat (.Net)](https://github.com/VladimirRepp/CS---TcpChat)
* [ASP.NET Core – Base (.Net)](https://github.com/VladimirRepp/ASP.Net_Core---Base)
...
* [MySQL (.Net)](https://github.com/VladimirRepp/CS---MySQL)
* [EF & Dapper Examples (.Net)](https://github.com/VladimirRepp/EFandDapper---ExampleOfEntityFrameworkAndDapper)
